                            ...
                            <div class="table-container" style="width: 100%">
                                <table class="table table-hover table-border table-sm" style="width: 100%">
                                    ...
                                    <tbody style="width: 100%">
                                        ...
                                        $sql = "SELECT a.audit_Id, a.action, a.officials_Id, a.datetime, o.officials_Id, o.first_name, o.last_name FROM audit_trail_table a INNER JOIN officials o ON a.officials_Id = o.officials_Id WHERE a.datetime BETWEEN '$from' AND '$to' ORDER BY a.audit_Id DESC";
