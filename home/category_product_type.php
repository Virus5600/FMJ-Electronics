<?php 
    ...
    if(isset($_POST['categoryProductBtn'])){
...
<body>
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-12">
                        <div class="main-title">
                            <i class="fa-solid fa-layer-group"></i><span>CATEGORY -><span style="font-size: 22px; color: #606FF2"><?php echo $categoryName?><span style="font-size: 22px; color: black">-></span> <?php echo $productName?></span></span>
                        </div>

                        <div class="addBtn-container d-flex justify-content-between mt-5 mb-3">
                            
                            <form action="category_product.php" method="POST">
                                <input type="text" name="categoryId" class="d-none" value="<?php echo $categoryId;?>">
                                <input type="text" name="categoryName" class="d-none" value="<?php echo $categoryName;?>">
                                <input type="submit" name="categoryBtn" class="btn btn-secondary" value="BACK">
                            </form>
                                        ...
                                        <div class="col-md-12">
                                            <form id="add-form">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" name="categoryProductName" class="form-control" value="<?php echo $productName;?>" readonly>
                                                </div>

                                                <div class="mt-3">
                                                    <label for="" style="font-size: 18px; font-weight: 600"><span class="text-danger" >* </span>Product Type</label>
                                                    <input type="text" name="categoryProductItemName" class="form-control" value="" >
                                                </div>
                            ...
                            <table class="table table-hover table-border table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none" scope="col">PRODUCT TYPE ID</th>
                                        <th scope="col">PRODUCT TYPES OF <span style="text-transform: uppercase"><?php echo $productName?></span></th>
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT p.category_product_Id, p.category_Id, p.product_Name, i.category_product_item_Id, i.category_Id, i.category_product_Id, i.product_item_name, i.archive FROM category_product_table p INNER JOIN category_product_item_table i ON p.category_product_Id = i.category_product_Id WHERE p.category_product_Id='$categoryProductId' AND i.archive='No'"; 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['product_item_name'];?></td>
                                        <td class="d-flex justify-content-around align-items-center">

                                            <button class="editBtn btn btn-secondary btn-sm" >EDIT</button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="edit_category_product_item" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <form id="edit-form">
                                                                ...
                                                                <label for="" style="font-size: 18px; font-weight: 600"><span class="text-danger" >* </span>PRODUCT TYPE</label>
                                                                <input type="text" name="edit_ItemName" id="edit_ItemName" value="" class="form-control" >
                                                                
                                                                <div class="modal-footer">
                                                                    
                                                                    <button type="button" id="" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <!-- <button type="button" class="btn btn-primary">ADD</button> -->
                                                                    <input type="submit" id="update_category_product_itemBtn" value="UPDATE" class="btn btn-primary">
                                            ...
                                            <form action="category_product_item_type.php" method="POST"> 

                                                <input type="text" name="categoryName" class="d-none" value="<?php echo $categoryName?>">
                                                <input type="text" name="productName" class="d-none" value="<?php echo $productName?>">
                                                ...
                                                <input type="text" name="categoryProductItemId" class="d-none" value="<?php echo $row['category_product_item_Id'];?>">
                                                <input type="text" name="productitemName" class="d-none" value="<?php echo $row['product_item_name'];?>">
                                                <input type="submit" name="categoryProductTypeBtn" class="btn btn-info btn-sm" value="VIEW">
                                            </form>

                                            <button type="button" class="btn btn-danger btn-sm" data-id="<?php echo $row['category_product_item_Id'];?>" onclick="confirmDelete(this);">
                                                ARCHIVE
                                            </button>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body d-flex justify-content-center align-items-center" style="height: 200px; width: 100%; flex-direction: column;  ">
                                                            <p class="h5">Are you sure you want to archive Product Type?</p>
                                                            <form action="" id="form-archive-producttype">
    ...
    <script>
        ...
        function confirmDelete(self){
            ...
            document.getElementById("form-archive-producttype").id.value = id;
        ...
        $(document).ready(function(){
            ...
            $("#archive_btn").click(function(e){
                    ...
                    $.ajax({
                        ...
                        method: "POST",
                        data: $("#form-archive-producttype").serialize() + "&action=archiveProductType",
            ...
            $('.editBtn').on('click', function(){
                console.log("Clikced")
                $('#edit_category_product_item').modal('show');
                ...
                $('#edit_ItemName').val(data[3]);
            });

            $("#update_category_product_itemBtn").click(function(e){
                e.preventDefault();

                $.ajax({
                    url: "../processPhp/edit_process.php",
                    method: "POST",
                    data: $("#edit-form").serialize() + '&action=editCategoryProductItem',
                    success: function (response){
            ...
            $("#addBtn").click(function(e){
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: $("#add-form").serialize() + '&action=addProductItem',
                    success: function (response){
                        console.log(response)
